...
@FragmentScope
public class SlideFixedModel extends BaseModel implements SlideFixedContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public SlideFixedModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
