...
public class LoginActivity extends HBaseActivity {
    ...
    protected void initWidget(Bundle savedInstanceState) {
        ...
        Log.e("hx", "LoginActivity-onCreate");
    }
    ...
    protected void onStart() {
        super.onStart();
        Log.e("hx", "LoginActivity-onStart");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.e("hx", "LoginActivity-onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.e("hx", "LoginActivity-onPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.e("hx", "LoginActivity-onStop");
    }
    ...
    protected void onRestart() {
        super.onRestart();
        Log.e("hx", "LoginActivity-onRestart");
    }
