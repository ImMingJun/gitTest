...
@FragmentScope
public class MaterialModel extends BaseModel implements MaterialContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MaterialModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
