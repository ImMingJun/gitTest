...
import com.shuyu.gsyvideoplayer.adapter.DanamakuAdapter;
...
public class DanmakuVideoPlayer extends StandardGSYVideoPlayer {
    ...
    protected void init(Context context) {
        ...
        llDanmakuWrapper = findViewById(R.id.llDanmakuWrapper);
    ...
    public void hideDanmuku(boolean hide){
        if(hide){
            llDanmakuWrapper.setVisibility(View.GONE);
        }else{
            llDanmakuWrapper.setVisibility(View.VISIBLE);
        }
    }
