...
public class StandardGSYVideoPlayer extends GSYVideoPlayer {
    ...
    protected void init(Context context) {
        super.init(context);
        mBottomProgressBar = (ProgressBar) findViewById(R.id.xyvideo_bottom_progressbar);
        mTitleTextView = (TextView) findViewById(R.id.xyvideo_title);
        mThumbImageViewLayout = (RelativeLayout) findViewById(R.id.xyvideo_thumb);
        mLockScreen = (ImageView) findViewById(R.id.xyvideo_lock_screen);

        mLoadingProgressBar = findViewById(R.id.xyvideo_loading);
    ...
    public int getLayoutId() {
        return R.layout.xy_video_layout_standard;
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        int id = v.getId();
        if (id == R.id.xyvideo_surface_container) {
        ...
        } else if (id == R.id.xyvideo_progress) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    cancelDismissControlViewTimer();
                    break;
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.xyvideo_surface_container) {
    ...
    public void setStartImg(int id){
        if(null != mStartButton){
            ((ENPlayView)mStartButton).setStartImg(id);
        }
    }

    public void setPauseImg(int id){
        if(null != mStartButton){
            ((ENPlayView)mStartButton).setPauseImg(id);
        }
    }
