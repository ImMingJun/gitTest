...
public abstract class GSYVideoPlayer extends GSYBaseVideoPlayer implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, TextureView.SurfaceTextureListener {
    ...
    protected void init(Context context) {
        ...
        mStartButton = findViewById(R.id.xyvideo_start);
        mSmallClose = findViewById(R.id.small_close);
        mBackButton = (ImageView) findViewById(R.id.xyvideo_back);
        mCoverImageView = (ImageView) findViewById(R.id.xyvideo_cover);
        mFullscreenButton = (ImageView) findViewById(R.id.xyvideo_fullscreen);
        mProgressBar = (SeekBar) findViewById(R.id.xyvideo_progress);
        mCurrentTimeTextView = (TextView) findViewById(R.id.xyvideo_current);
        mTotalTimeTextView = (TextView) findViewById(R.id.xyvideo_total);
        mBottomContainer = (ViewGroup) findViewById(R.id.xyvideo_layout_bottom);
        mTextureViewContainer = (ViewGroup) findViewById(R.id.xyvideo_surface_container);
        mTopContainer = (ViewGroup) findViewById(R.id.xyvideo_layout_top);
        if (isInEditMode())
            return;
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.xyvideo_surface_container && mCurrentState == CURRENT_STATE_ERROR) {
    ...
    public void onAutoCompletion() {
        ...
        if(GSYBaseVideoPlayer.isShowSmall){
...
//        }
    ...
    public static void releaseAllVideos() {
        if (IF_RELEASE_WHEN_ON_PAUSE) {
            if (GSYVideoManager.instance().listener() != null) {
//                GSYVideoManager.instance().listener().onAutoCompletion();
                GSYVideoManager.instance().listener().onCompletion();
            }
            GSYVideoManager.instance().releaseMediaPlayer();
        } else {
