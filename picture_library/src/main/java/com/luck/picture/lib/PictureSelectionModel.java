...
public class PictureSelectionModel {
    ...
    /**
     * @param videoMaxSize selection video max size 单位是M
     * @return
     */
    public PictureSelectionModel videoMaxSize(int videoMaxSize) {
        selectionConfig.videoMaxSize = videoMaxSize * 1024*1024;
        return this;
    }

    /**
     * 是否可以同时选择图片和视频
     * @param isAllSelection
     * @return
     */
    public PictureSelectionModel isAllSelection(boolean isAllSelection){
        selectionConfig.isAllSelection=isAllSelection;
        return this;
    }
    /**
