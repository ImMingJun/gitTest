        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (media != null) {
                ...
                if (isGif && !media.isCompressed()) {
                    PictrureMediaLoader.getInstance().displayRaw(imageView, path, 150, 300, true, new IPictureCallback() {
                        @Override
                    ...
                    PictrureMediaLoader.getInstance().displayRaw(imageView, path, 400, 800, false, new IPictureCallback() {
                        @Override
                        public void onSuccess() {
                            dismissDialog();
                        }
